...
export default function Home() {
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden border-b border-[#e2e8f0] bg-white">
        <div className="mx-auto max-w-7xl px-6 py-24 md:py-32">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl font-bold tracking-tight text-[#0f172a] md:text-6xl">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <Link
                href="/intake"
                className="inline-flex items-center gap-2 rounded-xl bg-[#1e3a5f] px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-[#1e3a5f]/20 transition hover:bg-[#2d4a6f]"
              >
              ...
              <Link
                href="/staff"
                className="inline-flex items-center gap-2 rounded-xl border border-[#e2e8f0] bg-white px-6 py-3 text-sm font-semibold text-[#0f172a] transition hover:bg-[#f8f9fb]"
              >
                Staff Dashboard
              </Link>
            </div>
      ...
      {/* Trust signals */}
      <section className="border-b border-[#e2e8f0] bg-[#f8f9fb]">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <div key={stat.label} className="flex items-center gap-3 rounded-xl bg-white p-4 shadow-sm">
                <stat.icon className="h-5 w-5 text-[#06b6d4]" />
                <div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-20">
        <div className="text-center">
          <h2 className="text-3xl font-bold tracking-tight text-[#0f172a]">How Nucleus Connect Works</h2>
        ...
        <div className="mt-12 grid gap-8 md:grid-cols-3">
          {[
            ...
            <div key={card.step} className="relative rounded-2xl bg-white p-6 shadow-sm border border-[#e2e8f0]">
              <div className="text-2xl font-bold text-[#06b6d4]/20">{card.step}</div>
              <h3 className="mt-2 text-lg font-semibold text-[#0f172a]">{card.title}</h3>
      ...
      <section className="mx-auto max-w-7xl px-6 pb-24">
        <div className="rounded-2xl bg-[#1e3a5f] p-10 text-center text-white shadow-xl">
          <h2 className="text-2xl font-bold md:text-3xl">Ready to explore the demo?</h2>
          <p className="mx-auto mt-4 max-w-xl text-[#cbd5e1]">
            Try the intake flow, view AI match results, and experience the staff approval dashboard with synthetic Utah data.
          </p>
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/intake"
              className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-semibold text-[#1e3a5f] shadow hover:bg-[#f8f9fb]"
            >
              Try Intake
              <ArrowRight className="h-4 w-4" />
            </Link>
            <Link
              href="/staff"
              className="inline-flex items-center gap-2 rounded-xl border border-white/20 px-6 py-3 text-sm font-semibold text-white hover:bg-white/10"
            >
